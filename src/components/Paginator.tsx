...
interface PaginatorProps {
  ...
  const Paginator = ({isLoading,page=1,pageCount,totalRecords,prevFun,nextFun}:PaginatorProps) => {
    return (
      <div className="flex flex-col items-center space-y-5 mx-auto mt-10">
        <p className="text-sm text-gray-600 mx-3">
          ...
          <span className="mx-1 font-semibold text-gray-900">{totalRecords}</span> Records
        </p>
